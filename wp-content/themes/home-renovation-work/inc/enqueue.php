...
add_action( 'customize_controls_enqueue_scripts', function() {
	...
	wp_enqueue_script(
		'homerenovationwork-customize-section-button',
	...
	wp_localize_script(
		'homerenovationwork-customize-section-button',
		'homerenovationwork_customizer_params',
		array( 
 ...
 */
function home_renovation_work_scripts() {
	...
	wp_enqueue_style('homerenovationwork-editor-style',get_template_directory_uri().'/assets/css/editor-style.css');

	wp_enqueue_style('homerenovationwork-main', get_template_directory_uri() . '/assets/css/main.css');
	
	wp_enqueue_style('homerenovationwork-woo', get_template_directory_uri() . '/assets/css/woo.css');
	
	wp_enqueue_style( 'homerenovationwork-style', get_stylesheet_uri() );
	...
	wp_enqueue_script('homerenovationwork-custom-js', get_template_directory_uri() . '/assets/js/theme.js', array('jquery'), false, true);

	if ( is_singular() && comments_open() && get_option( 'thread_comments' ) ) {
		wp_enqueue_script( 'comment-reply' );
	}
}
add_action( 'wp_enqueue_scripts', 'home_renovation_work_scripts' );
