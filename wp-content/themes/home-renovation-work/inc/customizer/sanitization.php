 ...
 */
function homerenovationwork_sanitize_checkbox( $checked ) {
	// Boolean check.
...
function homerenovationwork_switch_sanitization( $input ) {
    if ( true === $input ) {
        return 1;
    } else {
        return 0;
...
function homerenovationwork_sanitize_choices( $input, $setting ) {
    global $wp_customize; 
...
function homerenovationwork_sanitize_float( $input ) {
 ...
 */
function homerenovationwork_sanitize_hex_color( $hex_color, $setting ) {
 ...
 */
function homerenovationwork_sanitize_html( $html ) {
 ...
 */
function homerenovationwork_sanitize_image( $image, $setting ) {
 ...
 */
function homerenovationwork_sanitize_nohtml( $nohtml ) {
 ...
 */
function homerenovationwork_sanitize_number_absint( $number, $setting ) {
 ...
 *                    the setting default.
 */
function homerenovationwork_sanitize_range_value( $number, $setting ) {
 ...
 */
function homerenovationwork_sanitize_select( $input, $setting ) {
 ...
 */
function homerenovationwork_sanitize_url( $url ) {
	return esc_url_raw( $url );
}


/* Sanitization Text*/
function homerenovationwork_sanitize_text( $text ) {
	return wp_filter_post_kses( $text );
}

/* Sanitization Integer*/
function homerenovationwork_sanitize_integer( $input ) {
    if( is_numeric( $input ) ) {
        return intval( $input );
    }
}
